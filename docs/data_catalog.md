...
| product_number | NVARCHAR(50) | Alphanumeric identifier representing the product, used for categorisation or inventory. |
...
| maintenance_required | NVARCHAR(50) | Indicates whether the maintenance is required for the product (e.g., ‘Yes’, ‘No’). |
...
| sales_amount | INT | The monetary value of the sale for the line item, in whole currency units (e.g., 25). |
